...
MenuBackend menu = MenuBackend(menuUseEvent,menuChangeEvent);
  ...
  MenuItem menu_userbut   = MenuItem(menu, "User Buttons", 1);    // On Change: N/A. On Use: Show active configuration
    ...
    MenuItem menu_usrcfg6 = MenuItem(menu, "TIE DK1  TIE DK2DSK1        DSK2", 2);  // (As above)
...
void menuChangeEvent(MenuChangeEvent changed)
{
  ...
  if (changed.to.getName()=="MenuRoot")  {
    ...
    if (!(bool)changed.to.getRight())  {
        ...
        int prevButtonMode = userButtonMode;
        ...
        if (prevButtonMode != userButtonMode) {
             EEPROM.write(17,userButtonMode);
        }
